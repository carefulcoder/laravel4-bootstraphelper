...
/**
 * Yeah, I thought I should do some testing. Obviously since all I'm essentially
 * doing overly pretentious str_replace these are going to be quite dull but
 * thats the thing with regression issues, you never know!
...
class BootstrapBladeCompilerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testModal()
    {
        ...
        //so the HTML output contains a lot of spaces so the output looks nice in the source file. This should be fixed!
